...
import com.fusai.exception.TADBException;
import com.fusai.exception.TADBNotOpenException;
import com.fusai.lib.db.annotation.DatabaseColumn;
import com.fusai.lib.db.entity.BaseDB;
import com.fusai.lib.db.entity.EntityMetadata;
import com.fusai.lib.db.entity.FieldMetadata;
...
public class TASQLiteDatabase {
	...
	public long insert(BaseDB entity) {
		if (testSQLiteDatabase()) {
			...
			return mSQLiteDatabase.insert(entityMetadata.getTableName(),
					null, entityMetadata.createContentValues(entity));
		} else {
