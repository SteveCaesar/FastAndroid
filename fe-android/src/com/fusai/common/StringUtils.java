...
public class StringUtils { 
	...
	public static boolean isPhoneNumberValid(String phoneNumber) {
		...
		return phoneNumber.matches("^1[3|4|5|8][0-9]\\d{4,8}$");
	}
	...
	/**
	 * 一个散列方法,改变一个字符串(如一个字节数组)到一个散列适合使用作为一个磁盘文件名。
	 */
	public static String hashKeyForDisk(byte[] data) {
		String cacheKey;
		try {
			final MessageDigest mDigest = MessageDigest.getInstance("MD5");
			mDigest.update(data);
