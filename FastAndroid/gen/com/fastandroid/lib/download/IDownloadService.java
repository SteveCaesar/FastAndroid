 ...
 * Original file: E:\\workspace\\Android\\FastAndroid\\src\\com\\fastandroid\\lib\\download\\IDownloadService.aidl
 */
package com.fastandroid.lib.download;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.fastandroid.lib.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.fastandroid.lib.download.IDownloadService";
...
/**
 * Cast an IBinder object into an com.fastandroid.lib.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.fastandroid.lib.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.fastandroid.lib.download.IDownloadService))) {
return ((com.fastandroid.lib.download.IDownloadService)iin);
}
return new com.fastandroid.lib.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.fastandroid.lib.download.IDownloadService
{
...
@Override public void pauseAll() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
